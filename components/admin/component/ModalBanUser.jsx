...
const ModalBanUser = ({isOpen, onClose,onConfirm, userName, banDesription,setBanDescription}) => {
    useEffect(()=>{
          if(isOpen){
      ...
      return (
          ...
          <div className="div_modal_text">
            ...
            <p className='p_modal'>Вы действительно хотите заблокировать пользователя "{userName}"? Это действие нельзя отменить.</p>
          </div>
